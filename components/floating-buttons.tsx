...
export function FloatingButtons() {
  ...
  const whatsappMessage = encodeURIComponent(t.floating.whatsappMessage);
    ...
    <>
      <div className="fixed bottom-6 right-6 z-40 flex flex-col gap-3">
        ...
        <a
          ...
          className="group relative flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg transition-all duration-300 hover:scale-110 hover:shadow-xl hover:shadow-[#25D366]/40"
        >
          {/* Pulse ring */}
          <span className="absolute inset-0 rounded-full bg-[#25D366] opacity-0 group-hover:animate-ping group-hover:opacity-20" />
